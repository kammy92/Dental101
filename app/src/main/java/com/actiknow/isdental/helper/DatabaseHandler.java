...
import com.actiknow.isdental.model.Category;
import com.actiknow.isdental.model.CategoryMapping;
import com.actiknow.isdental.model.Event;
import com.actiknow.isdental.model.EventDetail;
import com.actiknow.isdental.model.EventSpeaker;
import com.actiknow.isdental.model.Exhibitor;
import com.actiknow.isdental.model.ExhibitorDetail;
import com.actiknow.isdental.model.Favourite;
import com.actiknow.isdental.model.Note;
import com.actiknow.isdental.model.Session;
import com.actiknow.isdental.model.SessionDetail;
import com.actiknow.isdental.model.SessionSpeaker;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "dental101";
...
//        db.execSQL ("DROP TABLE IF EXISTS " + TABLE_NOTES);
    ...
    public ArrayList<Event> getAllEventList () {
        ...
        String selectQuery = "SELECT *, (SELECT GROUP_CONCAT(" + EVNT_SPKR_NAME + ") FROM " + TABLE_EVENT_SPEAKERS + " WHERE " + EVNT_SPKR_EVNT_ID + " = " + EVNT_ID + ") as `evnt_speakers`  FROM " + TABLE_EVENTS + " ORDER BY " + EVNT_DATE + " ASC";
